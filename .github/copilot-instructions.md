...
- Use `org-core/tests/fixtures/` for testing - contains 8 org files with various structures
...
- Server provides resources: `org-files://`, `org://`, `org-outline://`, `org-heading://`, `org-id://`
